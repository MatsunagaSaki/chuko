				...
				if (have_posts()) : // WordPress ループ
					while (have_posts()) : the_post(); // 繰り返し処理開始 ?>
						<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            ...
                            <div class="cf">
                            <div class="fl w_50"><img src="<?php the_field('img_01'); ?>" alt="<?php the_title(); ?>" class="<?=$imgclass01?>" /></div>
							<div class="fr w_50"><img src="<?php the_field('img_02'); ?>" alt="<?php the_title(); ?>" class="<?=$imgclass02?>" /></div>
                            </div>
